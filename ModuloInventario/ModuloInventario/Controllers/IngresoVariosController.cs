...
namespace ModuloInventario.Controllers
{
    public class IngresoVariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SECUENCIAL,SECUENCIALRESPONSABLE,CODIGOINTERNO,UBICACION,SECUENCIALARTICULO,MARCA,MODELO,SERIE,PARTICULARIDAD,ESTADO,NODEFACTURA,VALORFACTURA,FECHAADQUISICION,OBSERVACIONES")] INGRESOVARIOS iNGRESOVARIOS)
        {
            ...
            ViewBag.UBICACION = new SelectList(db.SEDE, "SECUENCIAL", "CODIGO", iNGRESOVARIOS.UBICACION);
            return View(iNGRESOVARIOS);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SECUENCIAL,SECUENCIALRESPONSABLE,CODIGOINTERNO,UBICACION,SECUENCIALARTICULO,MARCA,MODELO,SERIE,PARTICULARIDAD,ESTADO,NODEFACTURA,VALORFACTURA,FECHAADQUISICION,OBSERVACIONES")] INGRESOVARIOS iNGRESOVARIOS)
        {
            if (ModelState.IsValid)
            {
