...
namespace ModuloInventario.Controllers
{
    public class IngresoComputadoresController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SECUENCIAL,SECUENCIALRESPONSABLE,CODIGOINTERNO,UBICACION,ARTICULO,MEMORIARAM,PROCESADOR,DISCODURO,LICENCIADO,OFFICE,MARCA,MODELO,SERIE,PARTICULARIDAD,ESTADO,NODEFACTURA,VALORFACTURA,FECHAADQUISICION,OBSERVACIONES")] INGRESOCOMPUTADORES iNGRESOCOMPUTADORES)
        {
            if (ModelState.IsValid)
            {
