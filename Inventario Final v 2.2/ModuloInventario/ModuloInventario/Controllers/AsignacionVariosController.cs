...
namespace ModuloInventario.Controllers
{
    public class AsignacionVariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SECUENCIAL,SECUENCIALRESPONSABLE,SECUENCIALVARIOS,UBICACION,FECHAASIGNACION,FECHAENTREGA,ESTADOENTREGA,OBSERVACIONES")] ASIGNACIONVARIOS aSIGNACIONVARIOS)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SECUENCIAL,SECUENCIALRESPONSABLE,SECUENCIALVARIOS,UBICACION,FECHAASIGNACION,FECHAENTREGA,ESTADOENTREGA,OBSERVACIONES")] ASIGNACIONVARIOS aSIGNACIONVARIOS)
        {
            if (ModelState.IsValid)
            {
